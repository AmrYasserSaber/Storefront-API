...
exports.deleteOrder = exports.ChooseOrder = exports.updateOrder = exports.getAllOrders = exports.create = void 0;
...
var getAllOrders = function (_req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var Orders, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
var ChooseOrder = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var Order, error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, Ordermodel.ChooseOrder(req.params.id)];
            case 1:
                Order = _a.sent();
                res.json({
                    status: 'succes',
...
exports.ChooseOrder = ChooseOrder;
