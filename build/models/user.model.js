        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        connect = _a.sent();
                        SQLOrder = "SELECT id,firstname,lastname FROM users";
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        connect = _a.sent();
                        SQLOrder = "INSERT INTO users (id,firstname,lastname,password)\n            values ($1,$2,$3,$4) returning id,firstname,lastname";
                        if (user.id) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        connect = _a.sent();
                        SQLOrder = "UPDATE users SET firstname=$1,lastname=$2 ,password=$3 WHERE id=$4  RETURNING id,firstname,lastname";
                        return [4 /*yield*/, connect.query(SQLOrder, [
                                user.firstname,
                                user.lastname,
                                user.password,
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        connect = _a.sent();
                        SQLOrder = "DELETE FROM users WHERE id='".concat(id, "' RETURNING id,firstname,lastname");
                        return [4 /*yield*/, connect.query(SQLOrder)];
                    case 2:
                        result = _a.sent();
                        connect.release();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        connect = _a.sent();
                        SQLOrder = "SELECT id,firstname,lastname FROM users WHERE id='".concat(id, "'");
                        return [4 /*yield*/, connect.query(SQLOrder)];
                    case 2:
                        result = _a.sent();
                        connect.release();
